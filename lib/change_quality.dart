    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
              ...
              Container(
                ...
                child: Wrap(
                  children: <Widget>[
                    ...
                    Text(
                      _controller.value.position.toString().split('.').first.padLeft(8, "0"),
                    ),
                    MaterialButton(
                      color: Colors.yellow,
                      onPressed: () {
          ...
          // loading spinner.
          return AspectRatio(aspectRatio: 16 / 9, child: Container(color: Colors.black, child: const Center(child: CircularProgressIndicator())));
        }
      },
    );
  }
